...
int main(int argc, char** argv) 
{
    ...
    ros::Subscriber sub = nh.subscribe("/pereption_topic", 1, perceptionDataCallback); // Remember to replace "/perception_data" with the actual topic name from dominic's ROS node that publishes the box pose information
