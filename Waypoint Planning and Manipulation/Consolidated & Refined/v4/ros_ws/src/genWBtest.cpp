...
void publishWaypointsMarkers(const std::vector<Point>& waypoints, ros::Publisher& publisher) 
{
    ...
    for (size_t i = 0; i < waypoints.size(); ++i) 
    {
        ...
        marker.header.frame_id = "map"; // Change to base_link for markers to show up on final demo rviz
...
void publishBoxMarkers(const std::vector<Point>& waypoints, ros::Publisher& publisher) 
{
    ...
    for (size_t i = 0; i < waypoints.size(); ++i) 
    {
        ...
        box.header.frame_id = "map"; // Change to base_link for markers to show up on final demo rviz
...
int main(int argc, char** argv) 
{
    ...
    ros::Subscriber sub = nh.subscribe("/pereption_topic", 1, perceptionDataCallback); // Replace with the actual topic name for demo "perception_topic", used "pereption_topic" to test for outdated rosbag
